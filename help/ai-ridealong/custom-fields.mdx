...
<AccordionGroup>
  ...
  <Accordion title="Who can create and manage custom fields?">
    Admins can access the custom fields settings page. Coaches and admins can create, edit, and delete field definitions. All users with access to a recording or call can view the field values.
  </Accordion>
