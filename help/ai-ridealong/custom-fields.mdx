...
- Once you manually edit an AI value, it stays as the manual value
...
<AccordionGroup>
  ...
  <Accordion title="Can I recompute AI values for a recording?">
    Yes. On the recording detail page, use the recompute action to re-run AI extraction. This won't overwrite values you've manually edited.
  </Accordion>
  ...
  <Accordion title="Who can create and manage custom fields?">
    Coaches and admins. All users with access to recordings can see the values, but only coaches and admins can create fields or edit values.
  </Accordion>
