...
description: "Send multi-step SMS and email campaigns to your contacts and handle replies with AI or your team."
---
...
<Steps>
  ...
  <Step title="Send contacts to the webhook">
    From your website or external system, make a POST request to add each contact:

    ```bash
    curl -X POST https://data.craftflow.co/api/outbound-campaigns/audiences/{audience_id}/add-member/ \
...
**Method:** `POST`
**URL:** `https://data.craftflow.co/api/outbound-campaigns/audiences/{audience_id}/add-member/`
