...
Only users with **Full Admin** or **Super Admin** permissions can create, edit, and revoke API keys. If you don't see the API Keys tab, ask an admin on your team to generate one for you.
